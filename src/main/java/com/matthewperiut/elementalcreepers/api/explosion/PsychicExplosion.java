...
public class PsychicExplosion
{
    ...
    public PsychicExplosion(Level var1, EntityBase var2, double var3, double var5, double var7, float var9) {
        this.level = var1;
        this.exploder = var2;
    ...
    public void doExplosionA() {
        ...
        Vec3f var31 = Vec3f.from(this.x, this.y, this.z);

        for(int var11 = 0; var11 < var9.size(); ++var11) {
            EntityBase var32 = (EntityBase)var9.get(var11);
            double var13 = var32.distanceTo(this.x, this.y, this.z) / (double)this.explosionSize;
            if(var13 <= 1.0D) {
                ...
                var19 /= var40;
                double var39 = (double)this.level.method_163(var31, var32.boundingBox);
    ...
    public void doExplosionB(boolean bl) {
        ...
        for(int var3 = var2.size() - 1; var3 >= 0; --var3) {
            ...
            int var6 = var4.y;
            int var7 = var4.z;
            int var8 = this.level.getTileId(var5, var6, var7);
            if (bl) {
                double var9 = (double)((float)var5 + this.level.rand.nextFloat());
                double var11 = (double)((float)var6 + this.level.rand.nextFloat());
                double var13 = (double)((float)var7 + this.level.rand.nextFloat());
                ...
                var23 *= (double)(this.level.rand.nextFloat() * this.level.rand.nextFloat() + 0.3F);
                var15 *= var23;
                var17 *= var23;
                var19 *= var23;
            ...
            if (var8 > 0) {
                BlockBase.BY_ID[var8].beforeDestroyedByExplosion(this.level, var5, var6, var7, this.level.getTileMeta(var5, var6, var7), 0.3F);
                this.level.setTile(var5, var6, var7, 0);
                BlockBase.BY_ID[var8].onDestroyedByExplosion(this.level, var5, var6, var7);
            }
        }
